...
public abstract class CellFunctionBehaviourImpl extends CyclicBehaviour implements CellFunction {
	...
	@Override
	public CellFunction init(String name, JsonObject conf, Cell caller) {
		this.name = name;
		this.conf = conf;
