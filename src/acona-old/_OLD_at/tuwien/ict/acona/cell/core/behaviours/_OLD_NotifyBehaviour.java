...
@Deprecated
public class _OLD_NotifyBehaviour extends OneShotBehaviour {
	...
	private static Logger log = LoggerFactory.getLogger(_OLD_NotifyBehaviour.class);
	
	public _OLD_NotifyBehaviour(List<String> subscribers, Datapoint subscribedData) {
