...
public class InternalBehaviourTester {
	...
	// /**
	// * In this test, one agent is created, which is the database. Another
	// agent is created that shall read a value from the database with a
	// blocking read function. The test is passed, if the read value is written
	// to a subscribed datapoint
	// *
	// */
	// @Test
	...
	// CellConfigJadeBehaviour cellreader =
	// CellConfigJadeBehaviour.newConfig("ReaderAgent",
	// "at.tuwien.ict.acona.cell.core.CellImpl");
	// //cellreader.setClass(CellImpl.class);
	// cellreader.addCondition(ConditionConfig.newConfig("startreadcondition",
	// "at.tuwien.ict.acona.cell.activator.conditions.ConditionIsNotEmpty"));
	// cellreader.addBehaviour(BehaviourConfigJadeBehaviour.newConfig("readBehaviour",
	// "at.tuwien.ict.acona.cell.core.helpers.TestReadAndWriteBehaviour")
	...
	// try {
	// readerAgent = this.util.createAgent(cellreader.getName(),
	...
	// CellConfigJadeBehaviour cellstorage =
	// CellConfigJadeBehaviour.newConfig("StorageAgent",
	// "at.tuwien.ict.acona.cell.core.InspectorCell");
	...
	// Class.forName(cellstorage.getClassName()), argsPublisher,
	// agentContainer);
	//
