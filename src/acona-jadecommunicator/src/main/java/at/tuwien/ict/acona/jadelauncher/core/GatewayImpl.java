...
import at.tuwien.ict.acona.jadelauncher.datastructurecontainer.GatewayMode;
import jade.core.Profile;
import jade.util.leap.Properties;
import jade.wrapper.gateway.JadeGateway;

public class GatewayImpl extends Thread implements Gateway {
	private static Logger log = LoggerFactory.getLogger(GatewayImpl.class);
	...
	public void init() throws Exception {
		try {
			...
			JadeGateway.init(BidirectionalGatewayAgent.class.getName(), args, p);
	...
	public Message sendSynchronousMessageToAgent(Message message, int timeout) throws Exception {
		...
		board.setCommunicationMode(GatewayMode.SYNC);
		board.setMessage(message);
