...
public class BlackboardBean implements java.io.Serializable {
	...
	private GatewayMode communicationMode = GatewayMode.ASYNC;
	...
	public void setCommunicationMode(GatewayMode mode) {
	...
	public boolean isSyncronizedRequest() {
		...
		if (this.communicationMode.equals(GatewayMode.SYNC)==true) {
			result = true;
		}
