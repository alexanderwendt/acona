...
public class CommuncatorLauncher extends Thread implements ListenerModule {
	
	private static CommuncatorLauncher launcher;
	...
	public static void main(String[] args) {
		...
		CommuncatorLauncher.launcher = new CommuncatorLauncher();
		try {
			launcher.init();
		} catch (Exception e) {
