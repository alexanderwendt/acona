 ...
 *
 */
public class AgentFunctionRequester {

	private static final Logger log = LoggerFactory.getLogger(AgentFunctionRequester.class);
	...
	public static void main(String[] args) {
		...
		new AgentFunctionRequester().run(param);
	}
}
