 ...
 *
 */
public abstract class AgentFunctionThreadImpl extends AgentFunctionImpl implements Runnable {
	...
	public AgentFunctionThreadImpl() {
	...
	protected void agentFunctionInit() throws Exception {
		try {
			...
			t = new Thread(this, this.getAgentName() + "#" + this.getFunctionName());
