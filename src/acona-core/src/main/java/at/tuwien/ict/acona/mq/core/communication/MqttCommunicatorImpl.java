package at.tuwien.ict.acona.mq.core.communication;
...
public class MqttCommunicatorImpl implements MqttCommunicator {
	...
	@Override
	public void init(String host, String userName, String password, AgentFunction cellFunction) throws Exception {
