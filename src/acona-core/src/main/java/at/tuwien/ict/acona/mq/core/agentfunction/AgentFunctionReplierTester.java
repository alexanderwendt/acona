 ...
 *
 */
public class AgentFunctionReplierTester {
	private static final Logger log = LoggerFactory.getLogger(AgentFunctionReplierTester.class);
...
//		}
		...
		new AgentFunctionReplierTester().run(param);
	}
}