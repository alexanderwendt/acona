...
public interface DataStorage {
	 ...
	 * 
	 * @param address:
	 *            Datappoint address. If * is put on the end, all sub addresses afterwards will be removed, e.g. datapoint1.* will remove datapoint1.test
	 * @param caller:
	 *            Caller agent
	 */
	...
	/**
	 * Reads a datapoint address. Wildcards can be added by using "*". Examples. read datapoint1.test.test will give exactly one datapoint. datapoint1.* will give all datapoints, which addresses start
	 * with datapoint1.
	 * 
	 * @param address
