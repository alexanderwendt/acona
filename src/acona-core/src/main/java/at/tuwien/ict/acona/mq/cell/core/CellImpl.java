...
import at.tuwien.ict.acona.mq.cell.cellfunction.CellCommunicatorFunctionImpl;
...
public class CellImpl implements Cell, Runnable {
	...
	public void init(CellConfig conf) throws Exception {
		...
		CellCommunicatorFunctionImpl commFunction = new CellCommunicatorFunctionImpl();
		commFunction.init(CellFunctionConfig.newConfig(agentName + "_" + "CommFunction", CellCommunicatorFunctionImpl.class), this);
